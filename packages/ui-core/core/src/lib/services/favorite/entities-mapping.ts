...
export const ENTITY_LINKS: Record<BaseEntityEnum, (id: string) => string> = {
	...
	[BaseEntityEnum.Employee]: (id) => `/pages/employees/edit/${id}`,
	[BaseEntityEnum.Candidate]: (id) => `/pages/employees/candidates/edit/${id}`,
	[BaseEntityEnum.Contact]: (id) => `/pages/contacts/edit/${id}`,
	[BaseEntityEnum.OrganizationTeam]: (id) => `/pages/organization/teams/edit/${id}`,
	...
	[BaseEntityEnum.OrganizationContact]: (id) => `/pages/organization/contacts/view/${id}`,
