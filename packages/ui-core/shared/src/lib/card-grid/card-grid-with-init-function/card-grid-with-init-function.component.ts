...
@Component({
	selector: 'ga-card-grid-with-init-function',
	templateUrl: './card-grid-with-init-function.component.html',
	styleUrls: ['./card-grid-with-init-function.component.scss'],
	standalone: false
})
/* This additional component was created to handle componentInitFunction
   without having to refactor the existing component
   that's used in many places throughout the app.*/
export class CardGridWithInitFunctionComponent implements OnInit {
