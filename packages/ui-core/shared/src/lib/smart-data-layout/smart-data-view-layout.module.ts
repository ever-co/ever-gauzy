...
// Attaches by element selector to every `angular2-smart-table` in scope, so the
// "still loading, not empty" fix lands on every grid without a template change.
const DIRECTIVES = [SmartTableSettlingDirective];
