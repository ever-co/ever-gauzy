...
export class WorkspaceSigninComponent extends TranslationBaseComponent implements OnInit {
	...
	/**
	 * FormGroup instance representing the workspace signin form.
	 */
	public form: UntypedFormGroup = WorkspaceSigninComponent.buildForm(this._fb);

	/**
	 * Static method to build the workspace signin form using Angular's FormBuilder.
	 */
	...
	/**
	 * Sends the magic code for workspace signin.
	 */
