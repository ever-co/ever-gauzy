...
// Re-exported so existing importers of this module keep working; the implementation now lives in
// @gauzy/core so the Zapier plugin shares it rather than carrying a second copy.
