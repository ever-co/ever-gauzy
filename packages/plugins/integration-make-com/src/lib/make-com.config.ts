 ...
 */
export const MAKE_BASE_URL = "https://www.make.com";

/** Make post install URl */
export const GAUZY_MAKE_POST_INSTALL_URL = "http://localhost:4200/#/pages/integrations/make"

/** Make redirect URL */
export const GAUZY_MAKE_REDIRECT_URL = `${process.env['API_BASE_URL']}/api/integration/make/oauth/callback`
/**
