...
export class CreatePaymentTables1791000000280 implements MigrationInterface {
	...
	public async postgresUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`CREATE UNIQUE INDEX "UQ_refund_reason_org_code" ON "refund_reason" ("organizationId", "code") WHERE "deletedAt" IS NULL`
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE UNIQUE INDEX "UQ_payment_provider_org_code" ON "payment_provider" ("organizationId", "code") WHERE "deletedAt" IS NULL`
		);
