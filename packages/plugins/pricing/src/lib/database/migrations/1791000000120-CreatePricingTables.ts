...
export class CreatePricingTables1791000000120 implements MigrationInterface {
	...
	public async postgresUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`CREATE UNIQUE INDEX "UQ_price_list_org_code" ON "price_list" (COALESCE("organizationId", '00000000-0000-0000-0000-000000000000'), "code") WHERE "deletedAt" IS NULL`
		);
		...
		await queryRunner.query(
			`CREATE UNIQUE INDEX "UQ_price_tier" ON "product_price" ("variantId", "currency", COALESCE("priceListId", '00000000-0000-0000-0000-000000000000'), COALESCE("minQuantity", -1), COALESCE("maxQuantity", -1)) WHERE "deletedAt" IS NULL`
		);
		await queryRunner.query(
		...
		// order.
		await queryRunner.query(
			`CREATE UNIQUE INDEX "UQ_price_preference" ON "price_preference" (COALESCE("organizationId", '00000000-0000-0000-0000-000000000000'), "attribute", "value") WHERE "deletedAt" IS NULL`
		);
		...
		await queryRunner.query(
			`CREATE UNIQUE INDEX "UQ_exchange_rate" ON "exchange_rate" (COALESCE("organizationId", '00000000-0000-0000-0000-000000000000'), "fromCurrency", "toCurrency", "validFrom") WHERE "deletedAt" IS NULL`
		);
