 ...
 * registration of its module. The order aggregate has ten tables and all ten are here exactly once: a
 * table that reaches the ORM through one path and not the other is a boot-time metadata failure, and a
 * hand-maintained list is how that happens.
 */
