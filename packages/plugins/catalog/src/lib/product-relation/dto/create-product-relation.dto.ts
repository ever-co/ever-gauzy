...
import { ProductRelationDTO } from './product-relation.dto';

/**
 * Create ProductRelation request DTO validation.
 *
 ...
 */
export class CreateProductRelationDTO extends PartialType(ProductRelationDTO) {}
