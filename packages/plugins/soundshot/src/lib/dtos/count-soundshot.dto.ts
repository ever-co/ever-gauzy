...
/**
 * Entity Count Soundshot DTO
 *
 * Represents the DTO for counting soundshots within a specific tenant and organization,
 * optionally filtered by a date range.
 */
export class CountSoundshotDTO {
	/**
	...
	/**
	 * The start date for filtering soundshot records.
