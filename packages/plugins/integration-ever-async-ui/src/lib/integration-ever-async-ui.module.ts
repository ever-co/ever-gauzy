...
export class IntegrationEverAsyncUiModule implements IOnPluginUiBootstrap, IOnPluginUiDestroy {
	private _hasAppliedRegistrations = false;

	private readonly _log = inject(LoggerService).withContext('IntegrationEverAsyncUiModule');
