 ...
 * @for (ext of extRegistry.getExtensions(PAGE_EXTENSION_SLOTS.DASHBOARD_WIDGETS); track ext.id) {
...
export class PageExtensionRegistryService {
	private readonly _extensions = new Map<PageExtensionSlotId, PageExtensionDefinition[]>();
