...
export class CreateTaskVersionTable1687974863736 implements MigrationInterface {
	...
	public async postgresUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`CREATE INDEX "IDX_379c8bd0ce203341148c1f99ee" ON "task_version" ("tenantId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_9c845f353378371ee3aa60f686" ON "task_version" ("organizationId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_3396dda57286ca17ab61fd3704" ON "task_version" ("name") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_e9fd8df772ad2d955a65f4c68a" ON "task_version" ("value") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_91988120385964f213aec8aa84" ON "task_version" ("projectId") `
		);
		await queryRunner.query(
	...
	public async postgresDownQueryRunner(
		...
		await queryRunner.query(
			`ALTER TABLE "task_version" DROP CONSTRAINT "FK_959e77718a2e76ee56498c1106a"`
		);
		await queryRunner.query(
			`ALTER TABLE "task_version" DROP CONSTRAINT "FK_91988120385964f213aec8aa84c"`
		);
		await queryRunner.query(
			`ALTER TABLE "task_version" DROP CONSTRAINT "FK_9c845f353378371ee3aa60f6865"`
		);
		await queryRunner.query(
			`ALTER TABLE "task_version" DROP CONSTRAINT "FK_379c8bd0ce203341148c1f99ee7"`
		);
		await queryRunner.query(
			`DROP INDEX "public"."IDX_959e77718a2e76ee56498c1106"`
		);
		await queryRunner.query(
			`DROP INDEX "public"."IDX_91988120385964f213aec8aa84"`
		);
		await queryRunner.query(
			`DROP INDEX "public"."IDX_e9fd8df772ad2d955a65f4c68a"`
		);
		await queryRunner.query(
			`DROP INDEX "public"."IDX_3396dda57286ca17ab61fd3704"`
		);
		await queryRunner.query(
			`DROP INDEX "public"."IDX_9c845f353378371ee3aa60f686"`
		);
		await queryRunner.query(
			`DROP INDEX "public"."IDX_379c8bd0ce203341148c1f99ee"`
		);
	...
	public async sqliteUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`DROP TABLE "task_version"`);
		await queryRunner.query(
			`ALTER TABLE "temporary_task_version" RENAME TO "task_version"`
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_379c8bd0ce203341148c1f99ee" ON "task_version" ("tenantId") `
		);
	...
	public async sqliteDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`DROP INDEX "IDX_379c8bd0ce203341148c1f99ee"`);
		await queryRunner.query(
			`ALTER TABLE "task_version" RENAME TO "temporary_task_version"`
		);
		await queryRunner.query(
			`CREATE TABLE "task_version" ("id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "tenantId" varchar, "organizationId" varchar, "name" varchar NOT NULL, "value" varchar NOT NULL, "description" varchar, "icon" varchar, "color" varchar, "isSystem" boolean NOT NULL DEFAULT (0), "projectId" varchar, "organizationTeamId" varchar)`
		);
