...
export class UpdateModuleToMemberRelationship1733140380074 implements MigrationInterface {
	name = 'UpdateModuleToMemberRelationship1733140380074';
	...
	public async postgresUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`CREATE INDEX "IDX_84e91db708746a20040843c887" ON "organization_project_module_employee" ("isActive") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_5851128af6de9c905f0e2be1e6" ON "organization_project_module_employee" ("isArchived") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_0b50ed382a8698a973b6201895" ON "organization_project_module_employee" ("tenantId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_c0f24a425e294a86c977ccafed" ON "organization_project_module_employee" ("organizationId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_4ee53d5870dcd9668536d617f0" ON "organization_project_module_employee" ("isManager") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_fa8fbbaa9d358aff5afb6492d3" ON "organization_project_module_employee" ("assignedAt") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_5c6124c57cf06b62e6c5d4ae2c" ON "organization_project_module_employee" ("organizationProjectModuleId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_230366f71696f7752afac3f53c" ON "organization_project_module_employee" ("employeeId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_5f4b71530d53181987bea86a93" ON "organization_project_module_employee" ("roleId") `
		);
		...
		await queryRunner.query(
			`ALTER TABLE "organization_project_module_employee" ADD CONSTRAINT "FK_c0f24a425e294a86c977ccafed6" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_project_module_employee" ADD CONSTRAINT "FK_5c6124c57cf06b62e6c5d4ae2c6" FOREIGN KEY ("organizationProjectModuleId") REFERENCES "organization_project_module"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_project_module_employee" ADD CONSTRAINT "FK_230366f71696f7752afac3f53cd" FOREIGN KEY ("employeeId") REFERENCES "employee"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
		);
		await queryRunner.query(
	...
	public async postgresDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`ALTER TABLE "organization_project_module_employee" DROP CONSTRAINT "FK_230366f71696f7752afac3f53cd"`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_project_module_employee" DROP CONSTRAINT "FK_5c6124c57cf06b62e6c5d4ae2c6"`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_project_module_employee" DROP CONSTRAINT "FK_c0f24a425e294a86c977ccafed6"`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_project_module_employee" DROP CONSTRAINT "FK_0b50ed382a8698a973b6201895a"`
		);
	...
	public async sqliteDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`DROP INDEX "IDX_84e91db708746a20040843c887"`);
		await queryRunner.query(
			`ALTER TABLE "organization_project_module_employee" RENAME TO "temporary_organization_project_module_employee"`
		);
		await queryRunner.query(
			`CREATE TABLE "organization_project_module_employee" ("deletedAt" datetime, "id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "isManager" boolean DEFAULT (0), "assignedAt" datetime, "organizationProjectModuleId" varchar NOT NULL, "employeeId" varchar NOT NULL, "roleId" varchar)`
		);
		await queryRunner.query(
			`INSERT INTO "organization_project_module_employee"("deletedAt", "id", "createdAt", "updatedAt", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "isManager", "assignedAt", "organizationProjectModuleId", "employeeId", "roleId") SELECT "deletedAt", "id", "createdAt", "updatedAt", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "isManager", "assignedAt", "organizationProjectModuleId", "employeeId", "roleId" FROM "temporary_organization_project_module_employee"`
		);
		...
		await queryRunner.query(
			`CREATE TABLE "organization_project_module" ("deletedAt" datetime, "id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "tenantId" varchar, "organizationId" varchar, "name" varchar NOT NULL, "description" text, "status" varchar, "startDate" datetime, "endDate" datetime, "public" boolean DEFAULT (0), "isFavorite" boolean DEFAULT (0), "parentId" varchar, "projectId" varchar, "creatorId" varchar, "managerId" varchar, "archivedAt" datetime, CONSTRAINT "FK_8a7a4d4206c003c3827c5afe5dc" FOREIGN KEY ("tenantId") REFERENCES "tenant" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_cd928adcb5ebb00c9f2c57e3908" FOREIGN KEY ("organizationId") REFERENCES "organization" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_4bb6fbfa64cf5d5977c2e5346a9" FOREIGN KEY ("parentId") REFERENCES "organization_project_module" ("id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_7fd3c8f54c01943b283080aefa3" FOREIGN KEY ("projectId") REFERENCES "organization_project" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_8f2054a6a2d4b9c17624b9c8a01" FOREIGN KEY ("creatorId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`
		);
		await queryRunner.query(
	...
	public async mysqlDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`ALTER TABLE \`organization_project_module_employee\` DROP FOREIGN KEY \`FK_230366f71696f7752afac3f53cd\``
		);
		await queryRunner.query(
			`ALTER TABLE \`organization_project_module_employee\` DROP FOREIGN KEY \`FK_5c6124c57cf06b62e6c5d4ae2c6\``
		);
		await queryRunner.query(
			`ALTER TABLE \`organization_project_module_employee\` DROP FOREIGN KEY \`FK_c0f24a425e294a86c977ccafed6\``
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`DROP INDEX \`IDX_230366f71696f7752afac3f53c\` ON \`organization_project_module_employee\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_5c6124c57cf06b62e6c5d4ae2c\` ON \`organization_project_module_employee\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_fa8fbbaa9d358aff5afb6492d3\` ON \`organization_project_module_employee\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_4ee53d5870dcd9668536d617f0\` ON \`organization_project_module_employee\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_c0f24a425e294a86c977ccafed\` ON \`organization_project_module_employee\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_0b50ed382a8698a973b6201895\` ON \`organization_project_module_employee\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_5851128af6de9c905f0e2be1e6\` ON \`organization_project_module_employee\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_84e91db708746a20040843c887\` ON \`organization_project_module_employee\``
		);
		await queryRunner.query(`DROP TABLE \`organization_project_module_employee\``);
		await queryRunner.query(
			`CREATE INDEX \`IDX_e6b6555e5fc6c5120110a0195c\` ON \`organization_project_module\` (\`managerId\`)`
