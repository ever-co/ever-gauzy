...
export class CreateOrganizationTaskSettingTable1689143129413
	implements MigrationInterface
{
	name = 'CreateOrganizationTaskSettingTable1689143129413';
	...
	public async postgresDownQueryRunner(
		...
		await queryRunner.query(
			`ALTER TABLE "organization_task_setting" DROP CONSTRAINT "FK_20a290f166c0810eafbf2717171"`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_task_setting" DROP CONSTRAINT "FK_19ab7adf33199bc6f913db277d7"`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_task_setting" DROP CONSTRAINT "FK_5830901876e426adfc15fb7341b"`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_task_setting" DROP CONSTRAINT "FK_582768159ef0c749e8552ea9bcd"`
		);
		await queryRunner.query(
			`DROP INDEX "public"."IDX_20a290f166c0810eafbf271717"`
		);
		await queryRunner.query(
			`DROP INDEX "public"."IDX_19ab7adf33199bc6f913db277d"`
		);
		await queryRunner.query(
			`DROP INDEX "public"."IDX_5830901876e426adfc15fb7341"`
		);
		await queryRunner.query(
			`DROP INDEX "public"."IDX_582768159ef0c749e8552ea9bc"`
		);
	...
	public async sqliteDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`DROP TABLE "temporary_organization_task_setting"`
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_20a290f166c0810eafbf271717" ON "organization_task_setting" ("organizationTeamId") `
		);
