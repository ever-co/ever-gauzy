...
export class CreateSubscriptionTable1732685369636 implements MigrationInterface {
	...
	public async sqliteUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`DROP INDEX "IDX_59d935a1de99d140f45550f344"`);
	...
	public async mysqlDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`DROP INDEX \`IDX_59d935a1de99d140f45550f344\` ON \`subscription\``);
