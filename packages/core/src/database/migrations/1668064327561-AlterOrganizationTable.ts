...
export class AlterOrganizationTable1668064327561 implements MigrationInterface {

    name = 'AlterOrganizationTable1668064327561';
    ...
    */
    public async postgresUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`ALTER TABLE "organization" ALTER COLUMN "inactivityTimeLimit" SET DEFAULT '10'`);
    }
    ...
    */
    public async postgresDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`ALTER TABLE "organization" ALTER COLUMN "inactivityTimeLimit" SET DEFAULT '1'`);
    }
