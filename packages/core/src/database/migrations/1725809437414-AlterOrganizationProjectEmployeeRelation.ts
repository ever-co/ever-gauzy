...
export class AlterOrganizationProjectEmployeeRelation1725809437414 implements MigrationInterface {
	name = 'AlterOrganizationProjectEmployeeRelation1725809437414';
	...
	public async postgresUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`CREATE INDEX "IDX_472eee165488bb8d0e7597e935" ON "organization_project_employee" ("archivedAt") `
		);
		await queryRunner.query(
	...
	public async postgresDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`DROP INDEX "public"."IDX_472eee165488bb8d0e7597e935"`);
	...
	public async sqliteDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`DROP INDEX "IDX_472eee165488bb8d0e7597e935"`);
	...
	public async mysqlUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		await queryRunner.query(
			`ALTER TABLE \`organization_project\` DROP FOREIGN KEY \`FK_05edb214d298384f9f918d6b5d2\``
		);
		await queryRunner.query(
		...
		await queryRunner.query(`DROP INDEX \`IDX_05edb214d298384f9f918d6b5d\` ON \`organization_project\``);
		await queryRunner.query(`ALTER TABLE \`organization_project\` DROP COLUMN \`managerId\``);
	...
	public async mysqlDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`DROP INDEX \`IDX_472eee165488bb8d0e7597e935\` ON \`organization_project_employee\``);
		...
		await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP COLUMN \`id\``);
		await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP COLUMN \`deletedAt\``);
		await queryRunner.query(`ALTER TABLE \`organization_project\` ADD \`managerId\` varchar(255) NULL`);
		await queryRunner.query(
			`CREATE INDEX \`IDX_05edb214d298384f9f918d6b5d\` ON \`organization_project\` (\`managerId\`)`
		);
		await queryRunner.query(
