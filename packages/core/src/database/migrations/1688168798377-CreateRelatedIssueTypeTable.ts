...
export class CreateRelatedIssueTypeTable1688168798377 implements MigrationInterface {
	...
	public async postgresDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`DROP INDEX "public"."IDX_4967ebdca0aefb9d43e56695e4"`);
		await queryRunner.query(`DROP INDEX "public"."IDX_d99fe5b50dbe5078e0d9a9b6a9"`);
		await queryRunner.query(`DROP INDEX "public"."IDX_61a7cb4452d9e23f91231b7fd6"`);
		await queryRunner.query(`DROP INDEX "public"."IDX_9423f99da972c150f85dbc11c1"`);
		await queryRunner.query(`DROP INDEX "public"."IDX_bed691e21fe01cf5aceee72295"`);
		await queryRunner.query(`DROP INDEX "public"."IDX_b7b0ea8ac2825fb981c1181d11"`);
