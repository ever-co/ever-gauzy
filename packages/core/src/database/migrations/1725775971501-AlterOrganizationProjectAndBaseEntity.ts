...
export class AlterOrganizationProjectAndBaseEntity1725775971501 implements MigrationInterface {
	...
	public async sqliteUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`DROP INDEX "IDX_c5c4366237dc2bb176c1503426"`);
		await queryRunner.query(`DROP INDEX "IDX_3e128d30e9910ff920eee4ef37"`);
		await queryRunner.query(`DROP INDEX "IDX_fdd58e4f13a3f4a92c70bcdb30"`);
		await queryRunner.query(`DROP INDEX "IDX_16c34de330ae8d59d9b31cce14"`);
		await queryRunner.query(`DROP INDEX "IDX_05edb214d298384f9f918d6b5d"`);
		await queryRunner.query(`DROP INDEX "IDX_489012234f53089d4b508f4aa1"`);
		await queryRunner.query(
			`CREATE TABLE "temporary_organization_project" ("id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "tenantId" varchar, "organizationId" varchar, "name" varchar NOT NULL, "startDate" datetime, "endDate" datetime, "billing" varchar, "currency" varchar, "public" boolean, "owner" varchar, "taskListType" varchar NOT NULL DEFAULT ('GRID'), "code" varchar, "description" varchar, "color" varchar, "billable" boolean, "billingFlat" boolean, "openSource" boolean, "projectUrl" varchar, "openSourceProjectUrl" varchar, "budget" integer, "budgetType" text DEFAULT ('cost'), "organizationContactId" varchar, "membersCount" integer DEFAULT (0), "imageUrl" varchar(500), "imageId" varchar, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "repositoryId" varchar, "isTasksAutoSync" boolean DEFAULT (1), "isTasksAutoSyncOnLabel" boolean DEFAULT (1), "syncTag" varchar, "deletedAt" datetime, "fix_relational_custom_fields" boolean, "archivedAt" datetime, "status" varchar, "icon" varchar, "archiveTasksIn" decimal, "closeTasksIn" decimal, "managerId" varchar, "defaultAssigneeId" varchar, CONSTRAINT "FK_904ae0b765faef6ba2db8b1e698" FOREIGN KEY ("repositoryId") REFERENCES "organization_github_repository" ("id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_bc1e32c13683dbb16ada1c6da14" FOREIGN KEY ("organizationContactId") REFERENCES "organization_contact" ("id") ON DELETE SET NULL ON UPDATE CASCADE, CONSTRAINT "FK_9d8afc1e1e64d4b7d48dd2229d7" FOREIGN KEY ("organizationId") REFERENCES "organization" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_7cf84e8b5775f349f81a1f3cc44" FOREIGN KEY ("tenantId") REFERENCES "tenant" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_063324fdceb51f7086e401ed2c9" FOREIGN KEY ("imageId") REFERENCES "image_asset" ("id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_05edb214d298384f9f918d6b5d2" FOREIGN KEY ("managerId") REFERENCES "employee" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_489012234f53089d4b508f4aa12" FOREIGN KEY ("defaultAssigneeId") REFERENCES "employee" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`
		);
		await queryRunner.query(
			`INSERT INTO "temporary_organization_project"("id", "createdAt", "updatedAt", "tenantId", "organizationId", "name", "startDate", "endDate", "billing", "currency", "public", "owner", "taskListType", "code", "description", "color", "billable", "billingFlat", "openSource", "projectUrl", "openSourceProjectUrl", "budget", "budgetType", "organizationContactId", "membersCount", "imageUrl", "imageId", "isActive", "isArchived", "repositoryId", "isTasksAutoSync", "isTasksAutoSyncOnLabel", "syncTag", "deletedAt", "fix_relational_custom_fields", "archivedAt", "status", "icon", "archiveTasksIn", "closeTasksIn", "managerId", "defaultAssigneeId") SELECT "id", "createdAt", "updatedAt", "tenantId", "organizationId", "name", "startDate", "endDate", "billing", "currency", "public", "owner", "taskListType", "code", "description", "color", "billable", "billingFlat", "openSource", "projectUrl", "openSourceProjectUrl", "budget", "budgetType", "organizationContactId", "membersCount", "imageUrl", "imageId", "isActive", "isArchived", "repositoryId", "isTasksAutoSync", "isTasksAutoSyncOnLabel", "syncTag", "deletedAt", "fix_relational_custom_fields", "archivedAt", "status", "icon", "archiveTasksIn", "closeTasksIn", "managerId", "defaultAssigneeId" FROM "organization_project"`
		);
		await queryRunner.query(`DROP TABLE "organization_project"`);
		await queryRunner.query(`ALTER TABLE "temporary_organization_project" RENAME TO "organization_project"`);
		await queryRunner.query(
	...
	public async sqliteDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`DROP INDEX "IDX_bd8360d2c539ae6b351129c86d"`);
		await queryRunner.query(`DROP INDEX "IDX_407463aef81b89c8bc5943ac8a"`);
		await queryRunner.query(`DROP INDEX "IDX_84a641af24ce125f296142216b"`);
		await queryRunner.query(`DROP INDEX "IDX_c271c2698e24de252f1fd148f0"`);
		await queryRunner.query(`DROP INDEX "IDX_0d66c27013f4c34b339738f210"`);
		await queryRunner.query(`DROP INDEX "IDX_4b69eac7a9f1b9e93eebe3a850"`);
		await queryRunner.query(`DROP INDEX "IDX_551be2742a129d5d8ff461e9fe"`);
		await queryRunner.query(`DROP INDEX "IDX_6b73b978dcd27856a83df0d23c"`);
		await queryRunner.query(`DROP INDEX "IDX_811cc78a6e4df2ae75d237e40e"`);
		await queryRunner.query(`DROP INDEX "IDX_290ccd540d1e1f450c408539a1"`);
		await queryRunner.query(`DROP INDEX "IDX_55dbb0b04712921d3c5dd7664e"`);
		await queryRunner.query(`DROP INDEX "IDX_888ffe5a395d1cf7afb001dc3a"`);
		await queryRunner.query(`DROP INDEX "IDX_66abaca4fc9c367203403310aa"`);
		await queryRunner.query(`DROP INDEX "IDX_21bba7ad2249260cc9d0022af9"`);
		await queryRunner.query(`DROP INDEX "IDX_fa9bdc44b90c4f32e658938a2d"`);
		await queryRunner.query(`DROP INDEX "IDX_e49cb4b6b256bd4a5edab1e4dd"`);
		await queryRunner.query(`DROP INDEX "IDX_6f87e00eb9e37242f01e6e5566"`);
		await queryRunner.query(`DROP INDEX "IDX_43f3709ff2b8dcc90c1809b023"`);
		await queryRunner.query(`DROP INDEX "IDX_bb9f95f639ced2a5b71395169e"`);
		await queryRunner.query(`DROP INDEX "IDX_b520b83e91a6d3c8ef33675efe"`);
		await queryRunner.query(`DROP INDEX "IDX_2cbd790171893d994992116f19"`);
		await queryRunner.query(`DROP INDEX "IDX_afad5ae421b31768c4232f7224"`);
		await queryRunner.query(`DROP INDEX "IDX_83df5ca85dae51ff9341e47785"`);
		await queryRunner.query(`DROP INDEX "IDX_a5c6d8b62974fb9e4161e09499"`);
		await queryRunner.query(`DROP INDEX "IDX_21aa702abacf7dabe11da12818"`);
		await queryRunner.query(`DROP INDEX "IDX_10ede978ae7c1b67755932eac6"`);
		await queryRunner.query(`DROP INDEX "IDX_6e8dc5c9992499a05248237e58"`);
		await queryRunner.query(`DROP INDEX "IDX_526e175838190ccc3c350df01a"`);
		await queryRunner.query(`DROP INDEX "IDX_259cb3e6d0d59edad2798b0ac3"`);
		await queryRunner.query(`DROP INDEX "IDX_c364d9cb885e274666950b1afc"`);
		await queryRunner.query(`DROP INDEX "IDX_d1689daf93e2cb6029a9ff96d2"`);
		await queryRunner.query(`DROP INDEX "IDX_f9fdc26bc564bf9f7963489f23"`);
		await queryRunner.query(`DROP INDEX "IDX_024d5a6727f6f4804d8cecfe32"`);
		await queryRunner.query(`DROP INDEX "IDX_93bb4c9fb014dda0d984e9060a"`);
		await queryRunner.query(`DROP INDEX "IDX_2ff61d100d00793724c099b86c"`);
		await queryRunner.query(`DROP INDEX "IDX_da2990e3e7d2047d950ab8edea"`);
		await queryRunner.query(`DROP INDEX "IDX_1255e02d6dddd4e09a5ddb10d4"`);
		await queryRunner.query(`DROP INDEX "IDX_1ddd19850ad49f4e61ad727018"`);
		await queryRunner.query(`DROP INDEX "IDX_0d379f40301224bfa5043dc7cc"`);
		await queryRunner.query(`DROP INDEX "IDX_6c388c8d50b4238ab077fdc800"`);
		await queryRunner.query(`DROP INDEX "IDX_8cdc64dbd7f2ed3f8850bd2592"`);
		await queryRunner.query(`DROP INDEX "IDX_aac7b3092d5d02d80deb5808b3"`);
		await queryRunner.query(`DROP INDEX "IDX_1c02d6337074841598e6952fed"`);
		await queryRunner.query(`DROP INDEX "IDX_f6c789158e91e7a6242174aaae"`);
		await queryRunner.query(`DROP INDEX "IDX_5a453f466165d928a495e158ac"`);
		await queryRunner.query(`DROP INDEX "IDX_3619176cb8845c5c03803caf9d"`);
		await queryRunner.query(`DROP INDEX "IDX_0ad88d687468141532bef9cc5e"`);
		await queryRunner.query(`DROP INDEX "IDX_12de5ef2de583b2e92a1dfee3d"`);
		await queryRunner.query(`DROP INDEX "IDX_98c2019d4a108469e30b265972"`);
		await queryRunner.query(`DROP INDEX "IDX_0eb547a970dfecff424eb2098b"`);
		await queryRunner.query(`DROP INDEX "IDX_3041f4d50857a4bc37dd72f233"`);
		await queryRunner.query(`DROP INDEX "IDX_577cfbbd0e9dedad955108df36"`);
		await queryRunner.query(`DROP INDEX "IDX_7c3776ae0d403baebc8a9387d8"`);
		await queryRunner.query(`DROP INDEX "IDX_18a46a61494103f9db1c42285d"`);
		await queryRunner.query(`DROP INDEX "IDX_41bff03b05f43a4e22e54cb83e"`);
		await queryRunner.query(`DROP INDEX "IDX_eed2b389448b96ec1118ca38ef"`);
		await queryRunner.query(`DROP INDEX "IDX_fdca637f69b879c6e95525a01f"`);
		await queryRunner.query(`DROP INDEX "IDX_e69de0d6c91d71407822a95bc9"`);
		await queryRunner.query(`DROP INDEX "IDX_89d6d92ce60b7b6de00449b30d"`);
		await queryRunner.query(`DROP INDEX "IDX_2dce278beac80aebe7e179d7c9"`);
		await queryRunner.query(`DROP INDEX "IDX_8b0d255d8f0ec4ca22e36249a8"`);
		await queryRunner.query(`DROP INDEX "IDX_c5075efc6dab483721af36616f"`);
		await queryRunner.query(`DROP INDEX "IDX_523b77d9dcbace8377fbca05ae"`);
		await queryRunner.query(`DROP INDEX "IDX_7f8ba01a73690cbabe6c6ab93c"`);
		await queryRunner.query(`DROP INDEX "IDX_3c5fdf6c34ed7a20fae6c9ae94"`);
		await queryRunner.query(`DROP INDEX "IDX_6c41095093c47ac91434a1bdf9"`);
		await queryRunner.query(`DROP INDEX "IDX_af48bbfa76f6261a5520e5e90f"`);
		await queryRunner.query(`DROP INDEX "IDX_5deae148453dfaf555b24d151f"`);
		await queryRunner.query(`DROP INDEX "IDX_d109b8470a4cf2662bec0a672b"`);
		await queryRunner.query(`DROP INDEX "IDX_60683da6db3f64a0767d40b291"`);
		await queryRunner.query(`DROP INDEX "IDX_cbb3f1eb241abc47103df48f83"`);
		await queryRunner.query(`DROP INDEX "IDX_636a95bda1eaf9fab00849dec2"`);
		await queryRunner.query(`DROP INDEX "IDX_21510dbb86b763f55a8bf4ec93"`);
		await queryRunner.query(`DROP INDEX "IDX_489012234f53089d4b508f4aa1"`);
		await queryRunner.query(`DROP INDEX "IDX_05edb214d298384f9f918d6b5d"`);
		await queryRunner.query(`DROP INDEX "IDX_16c34de330ae8d59d9b31cce14"`);
		await queryRunner.query(`DROP INDEX "IDX_fdd58e4f13a3f4a92c70bcdb30"`);
		await queryRunner.query(`DROP INDEX "IDX_1bff92d7a3b4b1f1a0e62a5122"`);
		await queryRunner.query(`DROP INDEX "IDX_94330f9121dd1e72fe31fdb3c5"`);
		await queryRunner.query(`DROP INDEX "IDX_8a11abe644b2cb5810bb65c8f9"`);
		await queryRunner.query(`DROP INDEX "IDX_bf9a2edebcda9ac2c59e4439cb"`);
		await queryRunner.query(`DROP INDEX "IDX_8cf81262c7cddfcf3fedcbc106"`);
		await queryRunner.query(`DROP INDEX "IDX_cdf46b38fd75cd7baebce81cc6"`);
		await queryRunner.query(`DROP INDEX "IDX_20aebc4219b9f9196f5ca2344d"`);
		await queryRunner.query(`DROP INDEX "IDX_ebff440aec581d4893ad743c7e"`);
		await queryRunner.query(`DROP INDEX "IDX_745828269219870069b3b46a7f"`);
		await queryRunner.query(`DROP INDEX "IDX_30bf8575f0744aa3b68b611985"`);
		await queryRunner.query(`DROP INDEX "IDX_c5df67196c2aca0a7fb6ffd274"`);
		await queryRunner.query(`DROP INDEX "IDX_04b8ef5663b40baa58e1b65160"`);
		await queryRunner.query(`DROP INDEX "IDX_40ee7b28c0ea835534a93b54bf"`);
		await queryRunner.query(`DROP INDEX "IDX_457cbab434fc9a031f03eb6211"`);
		await queryRunner.query(`DROP INDEX "IDX_599de8ec6ea69550c6d49c4ae1"`);
		await queryRunner.query(`DROP INDEX "IDX_00a3c849694b6f8be7b193c888"`);
		await queryRunner.query(`DROP INDEX "IDX_90aec772805c7fd508d71bedfe"`);
		await queryRunner.query(`DROP INDEX "IDX_842e81def8eef9f71a97496ff1"`);
		await queryRunner.query(`DROP INDEX "IDX_b6654519fbad729cdb490069be"`);
		await queryRunner.query(`DROP INDEX "IDX_02f667ad727ca0975d5022e695"`);
		await queryRunner.query(`DROP INDEX "IDX_3907c6f563fc45d824558d239d"`);
		await queryRunner.query(`DROP INDEX "IDX_5053bf22f9e0a5e9e8df7850da"`);
		await queryRunner.query(`DROP INDEX "IDX_2a9f9f6fa9064b328e277063a1"`);
		await queryRunner.query(`DROP INDEX "IDX_263e874cebea17ad3f2ba39e11"`);
		await queryRunner.query(`DROP INDEX "IDX_2a8cd17a33093bb6afed97e9d3"`);
		await queryRunner.query(`DROP INDEX "IDX_265b5cbc3e414bb3bb2facbb22"`);
		await queryRunner.query(`DROP INDEX "IDX_cc3487eb32dd8baa86a8043540"`);
		await queryRunner.query(`DROP INDEX "IDX_25e0f8060ed921994873391253"`);
		await queryRunner.query(`DROP INDEX "IDX_dae34450bed722e897370e2aec"`);
		await queryRunner.query(`DROP INDEX "IDX_84a5a399408725b9c8612767e0"`);
		await queryRunner.query(`DROP INDEX "IDX_03dbd727034c431934185d1d6f"`);
		await queryRunner.query(`DROP INDEX "IDX_3c0aa9d1eabc26757fbddc2bb9"`);
		await queryRunner.query(`DROP INDEX "IDX_c795b7a18f1213b980bcc91ffe"`);
		await queryRunner.query(`DROP INDEX "IDX_b1669a96371cbdb8fd8d4724d6"`);
		await queryRunner.query(`DROP INDEX "IDX_ca5fc2af0a26e454779d014a6a"`);
		await queryRunner.query(`DROP INDEX "IDX_6620af16ccd56e7e52b6ad914d"`);
		await queryRunner.query(`DROP INDEX "IDX_0edbfb90f0bc4c28eb57892900"`);
		await queryRunner.query(`DROP INDEX "IDX_e261b3b6ed4c6e79901fb3e1bc"`);
		...
		await queryRunner.query(`DROP INDEX "IDX_0c5508f4c86446f84d609e3b76"`);
		await queryRunner.query(`DROP INDEX "IDX_c17e703a7008f6b9c2770a5cba"`);
		await queryRunner.query(`DROP INDEX "IDX_a8e048dfb4d618068376407c86"`);
		await queryRunner.query(`DROP INDEX "IDX_185b880550575c61d4212896e2"`);
		await queryRunner.query(`DROP INDEX "IDX_08e391262cb3d4fbe9db97ecf8"`);
		await queryRunner.query(`DROP INDEX "IDX_9dff154a1be222c66c179ad14b"`);
		await queryRunner.query(`DROP INDEX "IDX_cee87c9b8743f0e81db8152f68"`);
		await queryRunner.query(`DROP INDEX "IDX_e69d60f1adcded4445095c4787"`);
		await queryRunner.query(`DROP INDEX "IDX_ce96229ae8d1d1af61348730da"`);
		await queryRunner.query(`DROP INDEX "IDX_35ac91a92c521b68277e780e6e"`);
		await queryRunner.query(`DROP INDEX "IDX_753f4b022ec98a0c8f38b370c0"`);
		await queryRunner.query(`DROP INDEX "IDX_284658fe519bca6048fd73ff72"`);
		await queryRunner.query(`DROP INDEX "IDX_36106478339961c8a17674a031"`);
		await queryRunner.query(`DROP INDEX "IDX_e99bb270f0fa89ea715a457d29"`);
		await queryRunner.query(`DROP INDEX "IDX_711fd0159178a0102abc4db336"`);
		await queryRunner.query(`DROP INDEX "IDX_67a4423093e3c311cb76275659"`);
		await queryRunner.query(`DROP INDEX "IDX_ac765cfc390ec77d765dd48b61"`);
		await queryRunner.query(`DROP INDEX "IDX_5cb080756923318f19f1d2eabe"`);
		await queryRunner.query(`DROP INDEX "IDX_df0a9a4b6ae0e3cab9c4f35436"`);
		await queryRunner.query(`DROP INDEX "IDX_f651e72ab42727f28c29441f1b"`);
		await queryRunner.query(`DROP INDEX "IDX_fa411cb89c9c6848d192d7f2e6"`);
		await queryRunner.query(`DROP INDEX "IDX_54b281d06e1a4e7e6ff640dab4"`);
		await queryRunner.query(`DROP INDEX "IDX_09f72a1a309aae91e0cd83949a"`);
		await queryRunner.query(`DROP INDEX "IDX_89ff7e0a8c37fdf7770b753776"`);
		await queryRunner.query(`DROP INDEX "IDX_bb09aa3130d0e54007a98523c5"`);
		await queryRunner.query(`DROP INDEX "IDX_745780f5553e56a3ca19bccf86"`);
		await queryRunner.query(`DROP INDEX "IDX_4985a92870282574f6fec8dd98"`);
		await queryRunner.query(`DROP INDEX "IDX_75bd5526e43c8801085225ffa9"`);
		await queryRunner.query(`DROP INDEX "IDX_c323aa830e10a871854d0a0408"`);
		await queryRunner.query(`DROP INDEX "IDX_2ada776a231239b8e99f78bf64"`);
		await queryRunner.query(`DROP INDEX "IDX_829e02292a572f25476c4e426c"`);
		await queryRunner.query(`DROP INDEX "IDX_e0c6443e0d2d5630067bc10ccf"`);
		await queryRunner.query(`DROP INDEX "IDX_5d74a3f25e6acfb6caec05ec65"`);
		await queryRunner.query(`DROP INDEX "IDX_6248458c7e237cef4adac4761d"`);
		await queryRunner.query(`DROP INDEX "IDX_9cb4931c7348b6c171f13b6216"`);
		await queryRunner.query(`DROP INDEX "IDX_586e6b1273ba2732ec0ee41a80"`);
		await queryRunner.query(`DROP INDEX "IDX_28ce717020729e36aa06cca5c5"`);
