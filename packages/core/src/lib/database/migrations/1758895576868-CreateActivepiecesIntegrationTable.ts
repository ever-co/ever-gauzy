...
export class CreateActivepiecesIntegrationTable1758895576868 implements MigrationInterface {
    ...
    */
    public async postgresUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "activepieces_integration" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "tenantId" uuid, "organizationId" uuid, "clientId" varchar NOT NULL, "clientSecret" text NOT NULL, "callbackUrl" varchar, "postInstallUrl" varchar, "isActive" boolean NOT NULL DEFAULT true, "description" varchar, "integrationId" uuid, CONSTRAINT "UQ_activepieces_integration_tenant_org" UNIQUE ("tenantId", "organizationId"), CONSTRAINT "PK_activepieces_integration" PRIMARY KEY ("id"))`);
    ...
    */
    public async sqliteUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_activepieces_integration" ("id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "tenantId" varchar, "organizationId" varchar, "clientId" varchar NOT NULL, "clientSecret" text NOT NULL, "callbackUrl" varchar, "postInstallUrl" varchar, "isActive" boolean NOT NULL DEFAULT (1), "description" varchar, "integrationId" varchar, CONSTRAINT "FK_activepieces_integration_tenant" FOREIGN KEY ("tenantId") REFERENCES "tenant" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_activepieces_integration_organization" FOREIGN KEY ("organizationId") REFERENCES "organization" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_activepieces_integration_integration" FOREIGN KEY ("integrationId") REFERENCES "integration_tenant" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_activepieces_integration"("id", "createdAt", "updatedAt", "tenantId", "organizationId", "clientId", "clientSecret", "callbackUrl", "postInstallUrl", "isActive", "description", "integrationId") SELECT "id", "createdAt", "updatedAt", "tenantId", "organizationId", "clientId", "clientSecret", "callbackUrl", "postInstallUrl", "isActive", "description", "integrationId" FROM "activepieces_integration"`);
        await queryRunner.query(`DROP TABLE "activepieces_integration"`);
    ...
    */
    ...
    public async mysqlUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE \`activepieces_integration\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`tenantId\` varchar(255) NULL, \`organizationId\` varchar(255) NULL, \`clientId\` varchar(255) NOT NULL, \`clientSecret\` text NOT NULL, \`callbackUrl\` varchar(255) NULL, \`postInstallUrl\` varchar(255) NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`description\` varchar(255) NULL, \`integrationId\` varchar(255) NULL, UNIQUE INDEX \`UQ_activepieces_integration_tenant_org\` (\`tenantId\`, \`organizationId\`), INDEX \`IDX_activepieces_integration_tenant\` (\`tenantId\`), INDEX \`IDX_activepieces_integration_organization\` (\`organizationId\`), INDEX \`IDX_activepieces_integration_integration\` (\`integrationId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`activepieces_integration\` ADD CONSTRAINT \`FK_activepieces_integration_tenant\` FOREIGN KEY (\`tenantId\`) REFERENCES \`tenant\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`activepieces_integration\` ADD CONSTRAINT \`FK_activepieces_integration_organization\` FOREIGN KEY (\`organizationId\`) REFERENCES \`organization\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`activepieces_integration\` ADD CONSTRAINT \`FK_activepieces_integration_integration\` FOREIGN KEY (\`integrationId\`) REFERENCES \`integration_tenant\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
