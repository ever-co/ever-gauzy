...
export class CreateTenantApiKeyTable1736330073887 implements MigrationInterface {
	name = 'CreateTenantApiKeyTable1736330073887';
	...
	public async sqliteUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`CREATE TABLE "temporary_tenant_api_key" ("deletedAt" datetime, "id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "apiKey" varchar NOT NULL, "apiSecret" varchar NOT NULL, "openAiSecretKey" varchar, "openAiOrganizationId" varchar, CONSTRAINT "FK_df44cc2b5ba1a4cc95850eea7c2" FOREIGN KEY ("tenantId") REFERENCES "tenant" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`
		);
		await queryRunner.query(
			`INSERT INTO "temporary_tenant_api_key"("deletedAt", "id", "createdAt", "updatedAt", "isActive", "isArchived", "archivedAt", "tenantId", "apiKey", "apiSecret", "openAiSecretKey", "openAiOrganizationId") SELECT "deletedAt", "id", "createdAt", "updatedAt", "isActive", "isArchived", "archivedAt", "tenantId", "apiKey", "apiSecret", "openAiSecretKey", "openAiOrganizationId" FROM "tenant_api_key"`
		);
		await queryRunner.query(`DROP TABLE "tenant_api_key"`);
	...
	public async sqliteDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`INSERT INTO "tenant_api_key"("deletedAt", "id", "createdAt", "updatedAt", "isActive", "isArchived", "archivedAt", "tenantId", "apiKey", "apiSecret", "openAiSecretKey", "openAiOrganizationId") SELECT "deletedAt", "id", "createdAt", "updatedAt", "isActive", "isArchived", "archivedAt", "tenantId", "apiKey", "apiSecret", "openAiSecretKey", "openAiOrganizationId" FROM "temporary_tenant_api_key"`
		);
