...
export class AlterInviteAllowedOrganizationTable1671107860058 implements MigrationInterface {

    name = 'AlterInviteAllowedOrganizationTable1671107860058';
    ...
    */
    public async postgresUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`ALTER TABLE "organization" ALTER COLUMN "invitesAllowed" SET DEFAULT true`);
    }
    ...
    */
    public async postgresDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`ALTER TABLE "organization" ALTER COLUMN "invitesAllowed" DROP DEFAULT`);
    }
