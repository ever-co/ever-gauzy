...
export class CreateZapierWebhookSubscriptionRepositoryTable1744014217496 implements MigrationInterface {
	...
	public async sqliteUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		await queryRunner.query(
			`CREATE TABLE "zapier_webhook_subscriptions" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "targetUrl" varchar NOT NULL, "event" varchar NOT NULL, "integrationId" varchar)`
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_7ac5d8545140784b6cefa771b6" ON "zapier_webhook_subscriptions" ("createdByUserId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_41a8a30ed05b7c03ba4ffa0a5a" ON "zapier_webhook_subscriptions" ("updatedByUserId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_00d7295263f758a465acc55028" ON "zapier_webhook_subscriptions" ("deletedByUserId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_4a20a462973171ee872620eb0c" ON "zapier_webhook_subscriptions" ("isActive") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_5feb24771dd5f4e24ce01f988d" ON "zapier_webhook_subscriptions" ("isArchived") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_4eeb6acd2b5eee53148b52526b" ON "zapier_webhook_subscriptions" ("tenantId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_7257011058fb1c910277b5ea0b" ON "zapier_webhook_subscriptions" ("organizationId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_5e200877326e3bb0f8cbc1c600" ON "zapier_webhook_subscriptions" ("targetUrl") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_b72a0994510a7705a4ae15f75a" ON "zapier_webhook_subscriptions" ("event") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_2d6e5ddfbfc190b802b8373a1c" ON "zapier_webhook_subscriptions" ("integrationId") `
		);
	...
	public async sqliteDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`DROP INDEX "IDX_7ac5d8545140784b6cefa771b6"`);
		await queryRunner.query(
			`ALTER TABLE "zapier_webhook_subscriptions" RENAME TO "temporary_zapier_webhook_subscriptions"`
		);
		await queryRunner.query(
			`CREATE TABLE "zapier_webhook_subscriptions" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "targetUrl" varchar NOT NULL, "event" varchar NOT NULL, "integrationId" varchar)`
		);
		await queryRunner.query(
			`INSERT INTO "zapier_webhook_subscriptions"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "targetUrl", "event", "integrationId") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "targetUrl", "event", "integrationId" FROM "temporary_zapier_webhook_subscriptions"`
		);
