...
export class CreatePaymentTermTables1791000000160 implements MigrationInterface {
	 ...
	 * `organizationKey`, for the reason `CreateSequenceTable1791000000000` sets out. Those columns exist
	 * on MySQL only and are declared by no entity — the documented price of a filtered index on a
