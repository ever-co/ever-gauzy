...
export class AddEmployeeBillingColumns1760702437715 implements MigrationInterface {

    name = 'AddEmployeeBillingColumns1760702437715';
    ...
    */
    public async postgresUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`ALTER TABLE "invoice_item" DROP COLUMN "currency"`);
    ...
    */
    public async postgresDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "invoice_item" ADD "currency" character varying`);
    }
