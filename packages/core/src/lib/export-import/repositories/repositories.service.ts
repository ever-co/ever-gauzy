...
import { TypeOrmTaskProjectSequenceRepository } from '../../tasks/project-sequence/repository/type-orm-task-project-sequence.repository';
...
export class RepositoriesService implements OnModuleInit {
	constructor(
		...
		public typeOrmTaskProjectSequenceRepository: TypeOrmTaskProjectSequenceRepository,
	...
	private async registerCoreRepositories() {
		this.repositories = [
			...
			{
				repository: this.typeOrmTaskProjectSequenceRepository
			},
