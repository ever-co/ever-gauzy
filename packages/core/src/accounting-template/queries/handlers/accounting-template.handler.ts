...
export class AccountingTemplateHandler implements IQueryHandler<AccountingTemplateQuery> {
	constructor(private readonly accountingTemplateService: AccountingTemplateService) {}
