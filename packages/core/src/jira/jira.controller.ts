...
import { Body, Controller, Get, Post, Req, Res, Type } from '@nestjs/common';
...
export class JiraController {
	...
	connectAppDescriptor = {
		 ...
		 */
		// key: envVars.APP_KEY,
		key: 'com.example.node-connect-app',
		 ...
		 */
		baseUrl: 'https://a28a-183-83-147-16.ngrok-free.app',
...
export function getControllerClass({ path }): Type<any> {
	...
	class HookController {
		constructor(private readonly probotDiscovery: any) {}
