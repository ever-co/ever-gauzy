...
export const environment: IEnvironment = {
	...
	ORGANIZATION_TEAM_JOIN_CODE_EXPIRATION_TIME: parseInt(process.env.ORGANIZATION_TEAM_JOIN_CODE_EXPIRATION_TIME) || 60 * 60 * 24, // default code expire time (1 day)
...
export const gauzyToggleFeatures: IGauzyFeatures = {
	...
	FEATURE_EMAIL_VERIFICATION:
		process.env.FEATURE_EMAIL_VERIFICATION === 'false' ? false : true,
};
