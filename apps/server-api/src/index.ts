...
import { createAboutWindow, createServerWindow, PluginMarketplaceWindow, SplashScreen } from '@gauzy/desktop-window';
...
const appProtocol = process.env.PROTOCOL || 'gauzy-api-server';
