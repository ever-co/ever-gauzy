...
import { EditOrganizationEmployeeTypes } from './edit-organization/edit-organization-settings/edit-organization-employeeTypes/edit-organization-employeeTypes.component';
...
const routes: Routes = [
	...
	},
	{
		...
		children: [
			...
			{
				path: 'employeeTypes',
				component: EditOrganizationEmployeeTypes
			}
		]
	}
];
