...
import { SharedModule, TruncatePipe } from '@gauzy/ui-core/shared';
...
@NgModule({
	...
	imports: [NbCheckboxModule, NbBadgeModule, NbIconModule, CommonModule, TranslateModule.forChild(), SharedModule, TruncatePipe],
