...
import { JitsuLoaderService } from './@core/services/analytics/jitsu-loader.service';
...
export function jitsuConfigFactory(provide: JitsuLoaderService) {
	return provide.load(
