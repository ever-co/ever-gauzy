...
import { Deal, Pipeline, PipelineCreateInput, PipelineFindInput } from '@gauzy/models';
  ...
  PipelineCreateInput>
{
  ...
  {
    return this.http.get<{ items: Deal[], total: number }>( `${ this.basePath }/${ id }/deals` ).toPromise();
  }
}
