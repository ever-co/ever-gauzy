...
import { TimesheetStatus, OrganizationProjects, Organization } from '@gauzy/models';
...
export const createDefaultTimeSheet = async (
  ...
  await Promise.all([
    createRandomTimeLogs(connection, createdTimesheets, defaultProjects, noOfTimeLogsPerTimeSheet),
