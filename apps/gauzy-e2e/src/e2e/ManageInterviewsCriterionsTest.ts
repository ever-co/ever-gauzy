...
describe('Manage interviews criterions test', () => {
	...
	//! Blank page
	it.skip('Should be able to edit technology stack', () => {
	...
	//! Blank page
	it.skip('Should be able to delete technology stack', () => {
	...
	//! Blank page
	it.skip('Should be able to add personal quality', () => {
	...
	//! Blank page
	it.skip('Should be able to edit personal quality', () => {
	...
	//! Blank page
	it.skip('Should be able to delete personal quality', () => {
