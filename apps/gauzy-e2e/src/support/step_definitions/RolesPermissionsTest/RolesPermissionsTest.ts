...
And('User can verify Super admin administration roles and permissions', () => {
	...
	rolesPermissionsPage.verifyState(RolesPermissionsPageData.ViewOrganizationProductcategorys, checked);
	rolesPermissionsPage.verifyState(RolesPermissionsPageData.EditOrganizationProductcategorys, checked);
	...
	rolesPermissionsPage.verifyState(RolesPermissionsPageData.ViewOrganizationProductcategorysAdmin, checked);
...
And('User can verify Data Entry administration roles and permissions', () => {
	...
	rolesPermissionsPage.verifyState(RolesPermissionsPageData.ViewOrganizationProductcategorys, notChecked);
	rolesPermissionsPage.verifyState(RolesPermissionsPageData.EditOrganizationProductcategorys, notChecked);
	...
	rolesPermissionsPage.verifyState(RolesPermissionsPageData.ViewOrganizationProductcategorysAdmin, notChecked);
