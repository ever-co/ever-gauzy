export const GoalsPage = {
	...
	leadDropdownCss: '#objective-lead button',
	deadlineDropdownCss: '#objective-deadline button',
	deadlineOptionCss: 'nb-option-list nb-option',
	...
	viewModalDeleteButtonCss: 'nb-dialog-container div.mt-3 button:last-of-type',
	...
	tableRowCss: 'ga-goals nb-card-body nb-accordion nb-accordion-item-header',
	...
	verifyGoalCss: 'ga-goals nb-card-body nb-accordion-item-header',
	// testing library
	actionsBarCss: '.actions-container',
	addButtonName: 'Add new Objective',
	editButtonName: 'Edit Objective',
	viewButtonName: 'View',
	addNewKeyResultButtonName: 'Add new key result'
};
