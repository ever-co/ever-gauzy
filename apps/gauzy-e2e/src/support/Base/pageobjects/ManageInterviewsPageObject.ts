export const ManageInterviewsPage = {
	...
	employeeMultiselectDropdownOptionCss:
	...
	notifyCandidateCss:
		'div.notify-checkboxes nb-checkbox > label > span.custom-checkbox',
	...
	nameTableCellCss:
		'table > tbody > tr.ng2-smart-row:first-of-type > td:nth-child(2)',
	titleTableCellCss:
		'table > tbody > tr.ng2-smart-row:first-of-type > td:nth-child(3)',
	tableOptionsButtonsCss:
		'table > tbody > tr:first-of-type > td:last-of-type nb-icon',
	...
	interviewCheckboxFiltersInputsCss:
		'nb-checkbox[status="warning"] input.native-input',
