...
// Converted 1:1 from the plain AddTasksTest.spec.ts: the single test() -> one Scenario, each
...
// to module scope and initialised at the top of the first step (one scenario per feature => safe).
...
When('I duplicate the task', async () => {
