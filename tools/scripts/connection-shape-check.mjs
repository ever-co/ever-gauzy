...
const PLATFORM_WITHOUT_WITH_DELETED = new Set([
	...
	'candidates', 'channelDomains', 'contactBuyers',
	...
	'exchangeRates', 'expenseCategories', 'expenses',
	...
	'operations', 'operationsByAggregate', 'orders',
	...
	'promotionUsages', 'refundLines', 'refundReasons',
	...
	'warehouseInventory', 'warehouses', 'webhookDeliveries',
