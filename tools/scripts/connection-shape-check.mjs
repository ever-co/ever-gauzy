...
const PLATFORM_WITHOUT_WITH_DELETED = new Set([
	...
	'emailTemplates', 'employeeAwards',
	'employeeDailyPlans', 'employeeLevels', 'employeeMembers',
	'employeeRecentVisits', 'employeeRecurringExpenses',
	'employeeTasks', 'entitySubscriptions',
	'equipmentSharingsByEmployee', 'equipmentSharingsByOrganization',
	'eventDeliveries', 'eventOutbox', 'eventTypes',
	'expenses',
	'favoritesByEmployee', 'goalGeneralSettings',
	'goalKpiTemplates', 'goalKpis', 'goalTemplates', 'goalTimeFrames',
	'goals', 'idempotencyKeys', 'importHistories',
	...
	'issueTypes', 'keyResultTemplates', 'keyResultUpdates',
	...
	'organizationContacts', 'organizationDepartments', 'organizationDepartmentsByEmployee',
	'organizationProjectModulesByEmployee', 'organizationRecurringExpenses', 'organizationSprints',
	'organizationStrategicInitiatives', 'organizationVendors',
	'payrollRuns', 'pipelineDeals',
	'productCategories', 'productOptions',
	'productTypes', 'productVariantPrices',
	'productVariantSettings', 'productVariants', 'products',
	'regions', 'reports', 'requestApprovals',
	'requestApprovalsByEmployee', 'rolePermissions', 'screeningTasks',
	'sequences',
	...
	'taskSizes', 'taskStatuses', 'taskVersions',
