...
const PLATFORM_WITHOUT_WITH_DELETED = new Set([
	...
	'eventDeliveries', 'eventOutbox',
	'expenses',
	'favoritesByEmployee',
	'idempotencyKeys', 'importHistories',
	'incomes', 'integrationEntitySettings', 'integrationTypes',
	...
	'requestApprovalsByEmployee', 'rolePermissions',
	'sequences',
	'syncedOrganizationProjects', 'tags', 'tagsByLevel',
	'taskPriorities', 'taskRelatedIssueTypes',
